...
from title.main.featureFunctions.headline_model_features import get_classification_dictionary
...
def headline_synthesis_initialise():
    ...
    file = open('model/headline_synthesis.pickle','rb')    #this file is missing --resolved
...
def get_headline_synthesis_score(headline_seq, dict_content_score, file_text):
    ...
    for index in range(0, len(headline_words)-2):
